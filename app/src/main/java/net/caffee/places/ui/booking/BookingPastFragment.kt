...
import net.caffee.places.databinding.FragmentBookingPastBinding

class BookingPastFragment : BaseFragment<FragmentBookingPastBinding, BookingPastViewModel>() {

    companion object {
        private const val TAG = "BookingPastFragment"
        const val TYPE_KEY = "type"

        fun getInstance(listener: Listener, screenType: Int): BookingPastFragment {
            val args = Bundle().apply {}
            args.putInt(TYPE_KEY, screenType)
            return BookingPastFragment().apply {
                arguments = args
    ...
    override fun layoutResId() = R.layout.fragment_booking_past

    override fun viewModelClass() = BookingPastViewModel::class.java
